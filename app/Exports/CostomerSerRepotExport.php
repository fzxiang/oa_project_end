...
class CostomerSerRepotExport implements FromCollection, WithColumnFormatting, ShouldAutoSize, WithEvents
{
    protected $data;
    ...
    */
    ...
    {
        return [
            'H' => NumberFormat::FORMAT_DATE_YYYYMMDD, //日期
            'I' => NumberFormat::FORMAT_DATE_YYYYMMDD, //日期
            'E' => NumberFormat::FORMAT_NUMBER_00, //金额保留两位小数
            'F' => NumberFormat::FORMAT_NUMBER_00, //金额保留两位小数
            'C' => self::FORMAT_CUSTOM, //自定义格式
        ];
    }
